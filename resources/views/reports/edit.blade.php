        ...
        <div>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <x-form.field>
                    ...
                    <div class="mt-2">
                        <x-form.input name="subject_id" id="subject_id" value="{{ $report->subject_id }}" required/>
                ...
                <x-form.field>
                    ...
                    <div class="mt-2">
                        <x-form.input name="student_id" id="student_id" value="{{ $report->student_id }}" required/>
                ...
                <x-form.field>
                    ...
                    <div class="mt-2">
                        <x-form.input name="points" id="points" value="{{ $report->points }}" required/>
